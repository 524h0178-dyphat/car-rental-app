          ...
          <div key={s.label} className="flex items-center">
            <div className="flex flex-col items-center gap-1.5">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${
                done ? 'bg-green-500 text-white' : active ? 'bg-brand-500 text-white shadow-orange' : 'bg-slate-100 text-slate-400'
              }`}>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {BENEFITS.map((b) => (
          <div key={b.title} className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl">
        ...
        <div className="flex items-start gap-3 p-4 bg-brand-50 border border-brand-100 rounded-xl sm:col-span-2">
...
function StepOwner({ form, setForm, onNext, onBack }: any) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="font-bold text-slate-900 text-lg">Thông tin chủ xe</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="sm:col-span-2">
          <label htmlFor="o-name" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="o-phone" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="o-email" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="o-cccd" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="o-addr" className="block text-sm font-medium text-slate-700 mb-1.5">
...
function StepCar({ form, setForm, onNext, onBack }: any) {
  ...
  return (
    <div className="space-y-4">
      <h2 className="font-bold text-slate-900 text-lg">Thông tin xe</h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="c-brand" className="block text-sm font-medium text-slate-700 mb-1.5">
            Hãng xe *
          </label>
        ...
        <div>
          <label htmlFor="c-model" className="block text-sm font-medium text-slate-700 mb-1.5">
            Mẫu xe *
          </label>
        ...
        <div>
          <label htmlFor="c-year" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="c-plate" className="block text-sm font-medium text-slate-700 mb-1.5">
            Biển số xe *
          </label>
        ...
        <div>
          <label htmlFor="c-trans" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="c-fuel" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div>
          <label htmlFor="c-seats" className="block text-sm font-medium text-slate-700 mb-1.5">
            Số chỗ ngồi *
          </label>
        ...
        <div>
          <label htmlFor="c-price" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div className="sm:col-span-2">
          <label htmlFor="c-prov" className="block text-sm font-medium text-slate-700 mb-1.5">
        ...
        <div className="sm:col-span-2">
          <label htmlFor="c-desc" className="block text-sm font-medium text-slate-700 mb-1.5">
...
function StepConfirm({ form, onBack, onSubmit, isLoading, error }: any) {
  ...
  return (
    <div className="space-y-5">
      <h2 className="font-bold text-slate-900 text-lg">Xác nhận thông tin</h2>

      {sections.map((sec) => (
        <div key={sec.title} className="card p-5">
          <h3 className="font-semibold text-slate-700 text-sm mb-3 pb-2 border-b border-slate-100">{sec.title}</h3>
      ...
      <div className="min-h-screen pt-20 bg-slate-50 flex items-center justify-center px-4">
        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 text-sm text-left mb-6 space-y-2">
            <p className="font-semibold text-slate-900 mb-3">Các bước tiếp theo</p>
            {[
    ...
    <div className="min-h-screen pt-20 bg-slate-50">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        <nav className="mb-6 flex items-center gap-2 text-sm text-slate-400">
          ...
          <span>/</span>
          <span className="text-slate-700">Ký gửi xe</span>
        </nav>
        <h1 className="text-2xl font-bold text-slate-900 mb-8">Đăng ký ký gửi xe</h1>
